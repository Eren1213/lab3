...
int main() {
    ...
    dp2.setilkNokta(Nokta());
    dp2.yazdir();

    cout << "1. doğru parçası için uzunluk değeri: " << dp.uzunluk() << endl;
    cout << "1. doğru parçası için orta nokta: " << dp.getortaNokta().toString() << endl;
    ...
    cout << "Daire 1: ";
    d1.yazdir();
    cout << "Alan: " << d1.alanHesapla() << ", Çevre: " << d1.cevreHesapla() << endl;

    cout << "Daire 2: ";
    d2.yazdir();
    cout << "Alan: " << d2.alanHesapla() << ", Çevre: " << d2.cevreHesapla() << endl;

    cout << "Daire 3: ";
    d3.yazdir();
    cout << "Alan: " << d3.alanHesapla() << ", Çevre: " << d3.cevreHesapla() << endl;

    cout << "Daire 1 ve Daire 2 Kesişim Durumu: " << d1.kesisimHesapla(d2) << endl;
    cout << "Daire 1 ve Daire 3 Kesişim Durumu: " << d1.kesisimHesapla(d3) << endl;
